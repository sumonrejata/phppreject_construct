...
?>
    ...
    <main>
        ...
        <div class="we-trusted-area trusted-padding">
            <div class="container">
                <?php while ($reselt=mysqli_fetch_assoc($aboutreturn)) { ?>
                    
                
                <div class="row d-flex align-items-end">
                    <div class="col-xl-7 col-lg-7">
                        <div class="trusted-img">
                            <img src="admin/uploadimage/<?php echo $reselt['about_image'];?>" alt="">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="trusted-caption">
                           <h2><?php echo $reselt['the_title'];?></h2>
                           <p><?php echo $reselt['the_content'];?></p>
                            <a href="#" class="btn trusted-btn"><?php echo $reselt['read_more'];?></a>
                        </div>
                    </div>
                </div>
            <?php } ?>
